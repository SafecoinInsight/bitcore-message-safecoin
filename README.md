...
bitcore-message-safecoin adds support for verifying and signing safecoin messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-safecoin
```

```sh
bower install bitcore-message-safecoin
```
